...
install:
	...
	install -Dm644 org.karlch.vimiv.gtk.metainfo.xml $(DESTDIR)$(APPDATAPREFIX)/org.karlch.vimiv.gtk.metainfo.xml
...
uninstall:
	...
	rm -f $(DESTDIR)$(APPDATAPREFIX)/org.karlch.vimiv.gtk.metainfo.xml
